# Estimation of p Values {#sec-clustering}
...
etable, estimates(OLS1) cstat(_r_b) showstars showstarsnote column(estimate)
...
etable, estimates(MLM1) cstat(_r_b) showstars showstarsnote column(estimate)
