...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{banner2.png}

}

\caption{\label{fig-communities}Studies where individuals are nested in
classrooms, communities, or countries}
...
\includegraphics[width=0.33\linewidth,height=\textheight,keepaspectratio]{plants.png}

}

\caption{\label{fig-growthchange}Studies of growth or change}

\end{figure}%

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{The Importance of Multilevel Models}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\bottomrule\noalign{}
\endlastfoot
15 & 77 & 83 & 15.83 & 0 & 1 & 1 & 2 & 54.99 \\
25 & 68 & 31 & 25.31 & 0 & 0 & 0 & 1 & 48.91 \\
22 & 86 & 2 & 22.2 & 0 & 1 & 0 & 5 & 48.6 \\
26 & 71 & 75 & 26.75 & 0 & 1 & 3 & 3 & 46.11 \\
10 & 59 & 47 & 10.47 & 0 & 1 & 1 & 3 & 54.1 \\
...
\chapter{Estimation of p Values}\label{sec-clustering}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Simulating The Data}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{A Naive Analysis Would Misconstrue The Results}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\KeywordTok{set} \DecValTok{linesize}\NormalTok{ 80 }\CommentTok{// set linesize for nice formatting}
...
\NormalTok{simulated\_multilevel\_data }\OtherTok{\textless{}{-}} \FunctionTok{read\_dta}\NormalTok{(}\StringTok{"simulated\_multilevel\_data.dta"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\subsection{The Equation}\label{the-equation}

\begin{equation}\protect\phantomsection\label{eq-crosssectional}{\begin{aligned}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{skimr}\SpecialCharTok{::}\FunctionTok{skim}\NormalTok{(simulated\_multilevel\_data)}
\end{Highlighting}
\end{Shaded}
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.2151}}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0645}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0645}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0753}}
...
\bottomrule\noalign{}
\endlastfoot
country & 0 & 1 & 15.50 & 8.66 & 1.00 & 8.00 & 15.50 & 23.00 & 30.00 &
▇▇▇▇▇ \\
HDI & 0 & 1 & 64.77 & 17.25 & 33.00 & 53.00 & 70.00 & 81.00 & 87.00 &
▅▂▅▇▇ \\
family & 0 & 1 & 50.50 & 28.87 & 1.00 & 25.75 & 50.50 & 75.25 & 100.00 &
▇▇▇▇▇ \\
identity & 0 & 1 & 0.50 & 0.50 & 0.00 & 0.00 & 0.00 & 1.00 & 1.00 &
▇▁▁▁▇ \\
intervention & 0 & 1 & 0.48 & 0.50 & 0.00 & 0.00 & 0.00 & 1.00 & 1.00 &
▇▁▁▁▇ \\
physical\_punishment & 0 & 1 & 2.48 & 1.36 & 0.00 & 2.00 & 2.00 & 3.00 &
5.00 & ▇▇▇▅▂ \\
warmth & 0 & 1 & 3.52 & 1.89 & 0.00 & 2.00 & 4.00 & 5.00 & 7.00 &
▃▃▇▃▃ \\
outcome & 0 & 1 & 52.43 & 6.53 & 29.61 & 48.02 & 52.45 & 56.86 & 74.84 &
▁▃▇▃▁ \\
\end{longtable}
}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,alt={Spaghetti Plot of Outcome by Warmth by Country}]{spagplot1.png}
\#\#\#\# R

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Random Slopes and Random Intercepts}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

This spaghetti plot is illustrating the idea of \emph{random intercepts}
and \emph{random slopes}. The multilevel model is estimating \emph{group
specific regression lines}, in this case \emph{country specific
regression lines}. Each \emph{country specific regression line} has its
own intercept and its own slope. The results presented in the multilevel
model are the result of \emph{averaging} these estimates into one
\emph{overall estimate}.

\end{tcolorbox}

\subsection{A Note On The Estimation of Random
Effects}\label{a-note-on-the-estimation-of-random-effects}

Procedures for estimating models with uncorrelated and correlated random
effects are detailed below (StataCorp 2023; Bates et al. 2015).
...
physical_pu~t |  -.9916657   .0797906   -12.43   0.000    -1.148052   -.8352791
     identity |  -.3004767   .2170295    -1.38   0.166    -.7258466    .1248933
1.intervent~n |   .6396427   .2174519     2.94   0.003     .2134448    1.065841
...
country: Independent         |
                 var(warmth) |   .0227504   .0257784      .0024689    .2096436
                  var(_cons) |   2.963975   .9737646      1.556777    5.643163
-----------------------------+------------------------------------------------
...
\NormalTok{               (}\DecValTok{1} \SpecialCharTok{+}\NormalTok{ warmth }\SpecialCharTok{||}\NormalTok{ country),}
             \AttributeTok{data =}\NormalTok{ simulated\_multilevel\_data)}
...
(Intercept)         52.011364   1.414872  36.760
...
\begin{equation}\protect\phantomsection\label{eq-longitudinal}{\begin{aligned}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,alt={Alternate Plot of Outcome by Time by Individual; First 10 Observations}]{spagplot2.png}
\#\#\#\# R
...
-----------------------------+------------------------------------------------
                  ...
                  id|country |   .3462837    .017146      .3134867    .3806097
------------------------------------------------------------------------------
\end{verbatim}
...
physical_pu~t |  -1.007897   .0497622   -20.25   0.000    -1.105429   -.9103647
   1.identity |  -.1276926   .1515835    -0.84   0.400    -.4247909    .1694056
1.intervent~n |   .8589966   .1519094     5.65   0.000     .5612596    1.156734
          HDI |  -.0005657   .0196437    -0.03   0.977    -.0390666    .0379352
        _cons |   50.46724   1.338319    37.71   0.000     47.84418    53.09029
-------------------------------------------------------------------------------
...
country: Independent         |
                 var(warmth) |   .0107584   .0127845      .0010477    .1104715
                  var(_cons) |   3.167089   .9146769      1.798157    5.578187
-----------------------------+------------------------------------------------
id: Independent              |
                      var(t) |   2.01e-09   4.14e-07      3.2e-185    1.3e+167
                  var(_cons) |   8.387272   .4724189      7.510628     9.36624
-----------------------------+------------------------------------------------
               var(Residual) |   26.02734   .4753701      25.11211    26.97592
------------------------------------------------------------------------------
...
\subsection{Nice Table of Results}\label{nice-table-of-results}
...
Sciences}, edited by Daniel Courgeau. Kluwer Academic Publishers.
...
edited by Neil J. Smelser and Paul B. Baltes. Pergamon.
...
Oliver, Mary, and Krista Tippett. 2015. \emph{{M}ary {O}liver: {``{I}
Got Saved by the Beauty of the World.''}} The On Being Project.
...
Grogan-Kaylor (2026). \emph{Multilevel Workshop}. Retrieved from
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{@book\{grogankaylor2026,}
