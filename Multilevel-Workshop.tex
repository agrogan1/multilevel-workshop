...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, colback=white, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, breakable, toptitle=1mm, leftrule=.75mm, bottomtitle=1mm, opacityback=0, titlerule=0mm, left=2mm, bottomrule=.15mm, toprule=.15mm]
...
Grogan-Kaylor (2025). \emph{Multilevel Thinking}. Retrieved from
