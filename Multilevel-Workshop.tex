...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, opacityback=0, breakable, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{The Importance of Multilevel Models}, titlerule=0mm, opacitybacktitle=0.6, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, opacityback=0, breakable, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, titlerule=0mm, opacitybacktitle=0.6, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, opacityback=0, breakable, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Simulating The Data}, titlerule=0mm, opacitybacktitle=0.6, left=2mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, opacityback=0, breakable, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{A Naive Analysis Would Misconstrue The Results}, titlerule=0mm, opacitybacktitle=0.6, left=2mm, arc=.35mm]
...
\[\text{outcome}_{ij} = \beta_0 + \beta_1 \text{parental warmth} + \beta_2 \text{physical punishment} + \\ \beta_3 \text{identity}_2 + \beta_4 \text{intervention} + \beta_5 HDI + \\ u_{0j} + u_{1j} \times \text{parental warmth} + e_{ij} \]
