...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, coltitle=black, colback=white, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, toprule=.15mm, titlerule=0mm, toptitle=1mm, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{The Importance of Multilevel Models}, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, coltitle=black, colback=white, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, titlerule=0mm, toptitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, coltitle=black, colback=white, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, titlerule=0mm, toptitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Simulating The Data}, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
