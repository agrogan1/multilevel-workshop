...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, colback=white, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, coltitle=black, toprule=.15mm, breakable, arc=.35mm, bottomrule=.15mm, left=2mm, opacityback=0]
