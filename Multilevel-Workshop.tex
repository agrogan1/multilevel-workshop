...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, coltitle=black, toprule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, arc=.35mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, left=2mm, bottomrule=.15mm]
