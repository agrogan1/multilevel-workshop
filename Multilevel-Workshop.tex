...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, colback=white, breakable, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, left=2mm, toprule=.15mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The Data Can Be Downloaded Here:}, leftrule=.75mm, bottomrule=.15mm]
