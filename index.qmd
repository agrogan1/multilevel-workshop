...
![Studies where individuals are nested in classrooms, communities, or countries](banner2.png){#fig-communities width=90%}
...
![Studies of growth or change](plants.png){#fig-growthchange width=33%}
